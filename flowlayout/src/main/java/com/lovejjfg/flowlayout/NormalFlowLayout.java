 ...
 */
public class NormalFlowLayout<T> extends FlowLayout implements TagAdapter.OnDataChangedListener {
    private static final String TAG = "NormalFlowLayout";
    private static final String KEY_DEFAULT = "key_default";
    private static final String KEY_CHOOSE_POS = "key_choose_pos";
    //    public int currentPos = -1;
    public ArrayList<Integer> mSelectedView = new ArrayList<>();
...
//                for (Integer pos : mSelectedView) {
//                    if (pos == i) {
//                        tagViewContainer.setChecked(true);
//                    }
//                }

                if (tagView instanceof Checkable) {
                    tagViewContainer.setChecked(((Checkable) tagView).isChecked());
                } else {
                    for (Integer pos : mSelectedView) {
                        if (pos == i) {
                            tagViewContainer.setChecked(true);
    ...
    public void setTagAdapter(TagAdapter<T> adapter) {
